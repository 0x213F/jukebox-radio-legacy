# Generated by Django 2.2.5 on 2019-11-29 17:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('number', models.PositiveIntegerField()),
                ('tracks', django.contrib.postgres.fields.jsonb.JSONField()),
                ('showing', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='records', to='music.Showing')),
            ],
            options={
                'abstract': False,
            },
