    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('deleted_at', models.DateTimeField(blank=True, null=True)),
                ('spotify_uri', models.CharField(blank=True, max_length=128, null=True)),
                ('spotify_name', models.CharField(blank=True, max_length=128, null=True)),
                ('spotify_duration_ms', models.PositiveIntegerField(blank=True, null=True)),
                ('spotify_img', models.CharField(blank=True, max_length=256, null=True)),
                ('youtube_id', models.CharField(blank=True, max_length=128, null=True)),
                ('youtube_name', models.CharField(blank=True, max_length=128, null=True)),
                ('youtube_duration_ms', models.PositiveIntegerField(blank=True, null=True)),
                ('youtube_img_high', models.CharField(blank=True, max_length=256, null=True)),
                ('storage_id', models.CharField(blank=True, max_length=128, null=True)),
                ('storage_filename', models.CharField(blank=True, max_length=128, null=True)),
                ('storage_name', models.CharField(blank=True, max_length=128, null=True)),
                ('storage_duration_ms', models.PositiveIntegerField(blank=True, null=True)),
            ],
            options={
                'abstract': False,
            },
